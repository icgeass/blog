...
public class TimeAgo {
    ...
    public static String toRelative(Date start) {
        return toRelative(System.currentTimeMillis() - start.getTime());
    }

    public static String toRelative(Date start, int level) {
        return toRelative(System.currentTimeMillis() - start.getTime(), level);
    }
