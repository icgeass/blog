...
CREATE TABLE `attach` (
  ...
  `name` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '文件名',
  `md5` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '文件md5',
...
CREATE TABLE `relation` (
  ...
  `yn` tinyint(4) DEFAULT NULL COMMENT '是否有效，1，有效，0，无效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='关系';
